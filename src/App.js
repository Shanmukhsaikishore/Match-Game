...
class App extends Component {
  ...
  onClickImage = imgId => {
    const {imageEle} = this.state
    if (imageEle.id === imgId) {
      this.setState(prevState => ({
        imageEle: imagesList[Math.floor(Math.random() * imagesList.length)],
  ...
  render() {
    ...
    this.startTimer()
    const {score, imageEle, currentTab, timerCount, isGameOver} = this.state
          ...
          <li className="text-content">
            ...
            <div className="timer">
              <img
                ...
                alt="timer"
              />
              <p className="score">{timerCount} sec</p>
            </div>
          </li>
        </ul>
        {isGameOver ? (
          ...
          <div className="card-container">
            <img src={imageEle.imageUrl} className="match-image" alt="match" />
